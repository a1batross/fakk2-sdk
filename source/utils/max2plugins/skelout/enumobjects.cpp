...
void GetObjectsEnumProc::GetObject( str name, SkelExport *skel, ExpInterface *ei, Interface *gi )
{
	interfaceptr = gi;
	m_skel = skel;
	m_name = name.c_str();
...
void GetNamesEnumProc::GetNames( Container<str> *names, ExpInterface *ei, Interface *gi )
{
	objectnames = names;
	interfaceptr = gi;
...
void GetBoneNamesEnumProc::GetNames( Container<str> *names, ExpInterface *ei, Interface *gi )
{
	bonenames = names;
	interfaceptr = gi;
...
int GetBoneNamesEnumProc::callback( INode *node )
{
	str    name;
	Object *obj;
	int    i;
...
void GetBonesEnumProc::GetBones( SkelExport *skel, ExpInterface *ei, Interface *gi )
{
	interfaceptr = gi;
	m_skel = skel;
...
int GetBonesEnumProc::callback( INode *node )
{
	Object *obj;
