...
# PROP Scc_ProjName ""$/fakk2_code/Utils/max3plugins/animout", NEJAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD CPP /nologo /G5 /MD /W3 /Gm /GX /ZI /Od /I "e:\sdk\max3sdk\maxsdk\include" /I "..\..\common" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "SIN" /YX /FD /c
...
# ADD LINK32 comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"e:\3dsmax3\Plugins\animout.dle" /libpath:"e:\sdk\max3sdk\maxsdk\lib"
