...
void Script::Skip( const char *string, bool crossline )
{
	GetToken( crossline );
...
UVector3 Script::GetVector( bool crossline )
{
...
void Script::GetVector( float vector[ 3 ], bool crossline )
{
...
void Script::Error( const char *error, ... )
{
	va_list argptr;
	char    text[ 1024 ];
