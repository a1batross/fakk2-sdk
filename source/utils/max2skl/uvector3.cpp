...
void UVector3::LerpVector( UVector3 w1, UVector3 w2, float t )
{
...
UVector3 UVector3::toAngles( void )
{
	float forward;
	float yaw, pitch;
...
void UVector3::RotatePointAroundVector( const UVector3 &dir, const UVector3 &point, float deg )
{
	UQuat about( dir );
...
void UVector3::MakePerp( const UVector3 &to )
{
	int
		 pos,
		i;
