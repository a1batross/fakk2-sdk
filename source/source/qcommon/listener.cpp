...
ScriptVariable *EventVar::GetVariable( Event &ev )
{
	if( type != IS_SCRIPTVARIABLE )
	{
		return NULL;
...
void Event::PrintEventDocumentation( Event *ePtr, FILE *event_file, qboolean html )
{
	int flags;
...
void Event::SetConsoleEdict( gentity_t *consoleedict )
{
