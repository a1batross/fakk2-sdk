...
#include "str.h"
void Container<str>::Archive( Archiver &arc )
{
	int i, num;
...
#include "vector.h"
void Container<Vector>::Archive( Archiver &arc )
{
	int i, num;
...
void Container<int>::Archive( Archiver &arc )
{
	int i, num;
...
void Container<float>::Archive( Archiver &arc )
{
	int i, num;
