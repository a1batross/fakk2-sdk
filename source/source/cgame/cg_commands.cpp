...
// ===============
void ClientGameCommandManager::BeginTagTraceImpactMark( Event *ev )
{
...
// ===============
void ClientGameCommandManager::EndTagTraceImpactMark( void )
{
	Vector  end;
	trace_t trace;
	int     i;
...
// ===============
void ClientGameCommandManager::BeginTagTraceImpactSpawn( Event *ev )
{
	// Setup ending function
...
// ===============
void ClientGameCommandManager::EndTagTraceImpactSpawn( void )
{
...
// ===============
void ClientGameCommandManager::TagTraceImpactSound( Event *ev )
{
	float   maxlength;
	Vector  end;
	trace_t trace;
...
// SetDuplicateCount
// ===============
void ClientGameCommandManager::SetDuplicateCount( Event *ev )
{
...
// SetWavy
// =============
void ClientGameCommandManager::SetWavy( Event *ev )
{
	str wave;
...
// SetTraceCount
// =============
void ClientGameCommandManager::SetTraceCount( Event *ev )
{
...
// Sound
// ===============
void ClientGameCommandManager::PlaySound( str sound_name, vec3_t *origin, int channel, float volume, float min_distance )
{
...
// AliasResource
// ===============
void AliasResource( int tikihandle, const char *alias, const char *realname, const char *parameters )
{
	if( tikihandle >= 0 )
	{
...
// UpdateBeam
// ===============
void ClientGameCommandManager::UpdateBeam( int tikihandle, int entity_number, spawnthing_t *beamthing )
{
	Vector        start, end;
	int           renderfx;
...
// UpdateEmitter
// ===============
void ClientGameCommandManager::UpdateEmitter( int tikihandle, vec3_t axis[3], int entity_number, int parent_number, Vector entity_origin )
{
...
// ===============
void ClientGameCommandManager::RemoveClientEntity( int number, int tikihandle, centity_t *cent, ctempmodel_t *p )
{
	int i;
...
void ProcessInitCommands( int tikihandle )
{
	int i, j, num_args;
...
// =================
void CG_ProcessEntityCommands( int tikihandle, int frame, int anim, int entnum, refEntity_t *ent, centity_t *cent )
{
	int        i, j;
	int        num_args;
...
// CG_ClientCommands
// =================
void CG_ClientCommands( int tikihandle, int new_frame, int new_anim, animstate_t *state, refEntity_t *ent, centity_t *cent )
{
	int anim;
	int frame;
