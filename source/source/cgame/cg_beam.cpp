// -----------------------------------------------------------------------------
//
//  $Logfile:: /fakk2_code/fakk2_new/cgame/cg_beam.cpp                        $
// $Revision:: 57                                                             $
//   $Author:: Aldie                                                          $
//     $Date:: 7/25/00 11:30p                                                 $
//
...
//
// $Log:: /fakk2_code/fakk2_new/cgame/cg_beam.cpp                             $
//
// 57    7/25/00 11:30p Aldie
// Made some memory changes and fixed some memory allocation bugs
//
// 56    7/18/00 4:31p Aldie
// Fix some client side multibeam stuff incase the whole group is not available
// to the client
//
// 55    6/27/00 7:16p Aldie
// Fixed it so beam emitters use alpha from entity
//
// 54    6/26/00 8:02p Aldie
// Fixed some checks for multibeams
//
// 53    6/17/00 1:54p Markd
// Added server restarted code
//
// 52    6/14/00 12:14p Markd
// more intel compiler bug fixes
//
// 51    6/08/00 3:51p Markd
// fixed unused variable warning
//
// 50    6/07/00 5:02p Aldie
// Fixed beam offset from owner bug
//
// 49    6/03/00 10:55a Markd
// Sped up tracing and debug print messages
//
// 48    5/30/00 11:00a Aldie
// Some mods for Circle of Protection powerup
//
// 47    5/16/00 6:24p Markd
// added cg_traceinfo support
//
// 46    5/06/00 3:27p Aldie
// Fix for beam emitters turning off
//
// 45    5/04/00 8:38p Aldie
// Made beam emitters work better
//
// 44    5/04/00 2:38p Aldie
// Fixed warnings
//
// 43    5/04/00 2:30p Aldie
// Fix for beam rendering tex coords
//
// 42    4/21/00 4:10p Markd
// fixed rope rendering
//
// 41    4/10/00 11:44a Markd
// fixed rope rendering
//
// 40    4/10/00 11:16a Markd
// added rope code
//
// 39    3/28/00 3:16p Aldie
// Fixed some beam problems for Pat
//
// 38    3/16/00 3:37p Aldie
// Fixed chceks for multi beam on invalid ents
//
// 37    3/01/00 1:45p Aldie
// Added some more beam functionality for beau.  Added taglist to do beam
// chains.
//
// 36    2/25/00 6:19p Aldie
// Changed texture coords on beams
//
// 35    2/15/00 7:04p Aldie
// More beam rendering fixes
//
// 34    2/14/00 7:34p Aldie
// Fixed some beam rendering issues
//
// 33    2/14/00 2:31p Aldie
// Fix for the first point on multibeam rendering (ropes)
//
// 32    1/27/00 11:47a Aldie
// Made beam_t a class
//
// 31    1/26/00 5:07p Aldie
// Removed warning
//
// 30    1/25/00 3:59p Aldie
// Added warning for multibeam
//
// 29    1/24/00 6:19p Aldie
// Fixed tex coords on the beams
//
// 28    1/22/00 12:41p Jimdose
// got rid of calls to vec3()
//
// 27    1/20/00 5:26p Aldie
// Fixed some beam bugs
//
// 26    1/12/00 3:17p Aldie
// Fixed beams so that there may be multiple beams on a model
//
// 25    1/05/00 7:26p Jimdose
...
//
// 24    11/10/99 6:35p Aldie
// Fix to draw the entire beam for ropes
//
// 23    10/29/99 7:16p Aldie
// Updated rope stuff
//
// 22    10/26/99 2:11p Aldie
// Fix beam crash
//
// 21    10/22/99 7:18p Aldie
// Fix for model lightning
//
// 20    10/22/99 6:29p Aldie
// Fix for beams in the sky
//
// 19    10/21/99 2:51p Aldie
// Added some more beam functions
//
// 18    10/20/99 12:20p Aldie
// Cleanup and fix color bug
//
// 17    10/19/99 4:57p Aldie
// More fixes for beams
//
// 16    10/19/99 4:30p Aldie
// Added beam wave effects
//
// 15    10/19/99 12:01p Aldie
// moved a piece of code
//
// 14    10/19/99 11:57a Aldie
// Added some more beam features
//
// 13    10/18/99 1:59p Aldie
// Lots of fixes for beams and stuff
//
// 12    10/14/99 7:19p Aldie
// Fix some beam stuff
//
// 11    10/13/99 3:26p Aldie
// Various fixes for particles, beams and lensflares
//
// 10    10/08/99 5:47p Aldie
// More beam stuff
//
// 9     10/08/99 5:07p Aldie
// More beam stuff and fix for UI_CenterPrint
//
// 8     10/07/99 7:14p Aldie
// more beam stuff (woohoo!)
//
// 7     10/07/99 3:08p Aldie
// more beam fun
//
// 6     10/06/99 3:11p Aldie
...
void CG_MultiBeamAddPoints( vec3_t start, vec3_t end, int numsegments, int flags, float minoffset, float maxoffset, qboolean addstartpoint )
{
...
void CG_MultiBeamEnd( float scale, int renderfx, const char *beamshadername, byte modulate[4], int flags, int owner, float life )
{
...
void CG_BuildRendererBeam( Vector start, Vector end, float angleVar, int numSubdivisions, byte color[4], int beamshader, float scale, float overlap, int owner, float life, int flags, float startalpha, float alphastep, int renderfx )
{
...
void CG_CreateBeam( vec3_t start, vec3_t dir, int owner, qhandle_t hModel, float alpha, float scale, int flags, float length, int life, qboolean create, vec3_t endpointvec, int min_offset, int max_offset, int overlap, int numSubdivisions, int delay, const char *beamshadername, byte modulate[4], int numspherebeams, float sphereradius, int toggledelay, float endalpha, int renderfx, const char *name )
{
	int     i;
	beam_t  *b;
	vec3_t  end;
