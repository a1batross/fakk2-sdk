...
inline void Vector::setPitch( double pitch )
{
	x = (float)pitch;
}

inline void Vector::setYaw( double yaw )
{
	y = (float)yaw;
}

inline void Vector::setRoll( double roll )
{
	z = (float)roll;
}
...
inline Vector operator*( Vector a, double b )
{
...
inline void Vector::AngleVectors( Vector *forward, Vector *right, Vector *up )
{
	float        angle;
...
inline void Quat::set( double x, double y, double z, double w )
{
	this->x = x;
	this->y = y;
	this->z = z;
...
inline Quat operator*( Quat a, double b )
{
