// -----------------------------------------------------------------------------
//
//  $Logfile:: /fakk2_code/fakk2_new/cgame/cg_testemitter.cpp                 $
// $Revision:: 18                                                             $
//   $Author:: Markd                                                          $
//     $Date:: 7/22/00 5:50p                                                  $
//
...
//
// $Log:: /fakk2_code/fakk2_new/cgame/cg_testemitter.cpp                      $
//
// 18    7/22/00 5:50p Markd
// added flushtikis support
//
// 17    7/10/00 11:54p Markd
// added exit level code
//
// 16    6/14/00 12:14p Markd
// more intel compiler bug fixes
//
// 15    5/15/00 2:19p Aldie
// Added new tempmodel system and added player accumulated pain
//
// 13    3/16/00 7:35p Aldie
// Added t2 flags to testemitter
//
// 12    3/16/00 5:09p Aldie
// Added some optimizations for tempmodels
//
// 11    3/15/00 11:01a Aldie
// Changed m_emitters to container instead of array.
//
// 10    3/11/00 4:47p Aldie
// Fix for scaleupdown
//
// 9     3/04/00 6:03p Aldie
// Made commandManager static
//
// 8     2/09/00 4:27p Aldie
// Fixed pause on the client emitters
//
// 7     1/26/00 11:35a Aldie
// New data structures for emitters
//
// 6     1/22/00 12:41p Jimdose
// got rid of calls to vec3()
//
// 5     10/22/99 4:29p Aldie
// Added debuglines
//
// 4     10/13/99 3:26p Aldie
...
// UpdateTestEmitter
// ===============
void ClientGameCommandManager::UpdateTestEmitter( void )
{
	int           count;
	Vector        delta;
...
void ClientGameCommandManager::DumpEmitter( void )
{
	cvar_t *filename;
	str    buff;
	int    i;
...
void ClientGameCommandManager::SetTestEmitterValues( void )
{
	vec3_t angles;
	vec3_t axis[3];
...
void ClientGameCommandManager::TestEmitter( void )
{
