...
ClassDef::ClassDef( const char *classname, const char *classID, const char *superclass, ResponseDef<Class> *responses, void *( *newInstance )( void ), int classSize )
{
	ClassDef *node;
...
qboolean Class::inheritsFrom( const char *name )
{
	ClassDef *c;
...
qboolean Class::isInheritedBy( const char *name )
{
	ClassDef *c;
