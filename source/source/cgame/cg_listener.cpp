...
Event::Event( str &command, int flags )
{
	str *t;
...
double Event::GetDouble( int pos )
{
	const char *text;
...
#if 0
void Listener::FloatVar( Event &e, float *var, float defaultvalue )
{
}

void Listener::IntVar( Event &e, int *var, float defaultvalue )
{
}

void Listener::StringVar( Event &e, str *var, const char *defaultvalue )
{
}

void Listener::StringVar( Event &e, char **var, const char *defaultvalue )
{
}

void Listener::VectorVar( Event &e, Vector *var, Vector defaultvalue )
{
}

#endif

qboolean Listener::ValidEvent( Event &e )
{
	ClassDef *c;
	int      ev;
...
qboolean Listener::ValidEvent( const char *name )
{
	ClassDef *c;
	int      ev;
...
void Listener::PostEvent( Event *ev, float time )
{
...
void CG_ProcessPendingEvents( void )
{
	eventcache_t *event;
	float        t;
	int          num;
