...
void Pain::SetPainAnim( Actor &self, int new_pain_type, int new_anim_number )
{
	str anim_name;
...
int Pain::GetNumberOfPainAnims( Actor &self, int new_pain_type )
{
	str anim_name;
	str real_anim_name;
	int i;
...
void Pain::AnimDone( Event *ev )
{
	anim_done = true;
}

qboolean Pain::Evaluate( Actor &self )
{
	str anim_name;
...
void Watch::SetArgs( Event *ev )
{
	turn_speed = ev->GetFloat( 1 );
}

void Watch::Begin( Actor &self )
{
...
qboolean Watch::Evaluate( Actor &self )
{
	Vector dir;
...
void HeadWatch::SetArgs( Event *ev )
{
...
void HeadWatch::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void HeadWatch::Begin( Actor &self )
{
...
qboolean HeadWatch::Evaluate( Actor &self )
{
	Vector dir;
	Vector angles;
	int    tag_num;
...
void TorsoTurn::SetArgs( Event *ev )
{
...
void TorsoTurn::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void TorsoTurn::Begin( Actor &self )
{
...
qboolean TorsoTurn::Evaluate( Actor &self )
{
	Vector dir;
	Vector angles;
	int    tag_num;
...
void GotoPathNode::AnimDone( Event *ev )
{
...
void Flee::FindFleeNode( Actor &self )
{
	int       i;
	PathNode  *start_node;
	pathway_t *path;
...
void Talk::SetUser( Sentient *user )
{
	ent_listening = user;
}

void Talk::AnimDone( Event *ev )
{
	turnto.ProcessEvent( EV_Behavior_AnimDone );
}

void Talk::Begin( Actor &self )
{
	Vector     dir;
	Vector     angles;
...
qboolean Talk::Evaluate( Actor &self )
{
	Vector dir;
	Vector angles;
	Event  *event;
...
qboolean JumpToPathNode::Evaluate( Actor &self )
{
...
void FlyToPoint::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyToPoint::Begin( Actor &self )
{
	avoidtime = 0;
...
qboolean FlyToPoint::Evaluate( Actor &self )
{
	trace_t trace;
	Vector  dir;
	Vector  ang;
...
void FlyToPoint::End( Actor &self )
{
...
void FlyCloseToEnemy::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
...
void FlyCloseToEnemy::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyCloseToEnemy::Begin( Actor &self )
{
	if( anim.length())
	{
		self.SetAnim( anim );
...
qboolean FlyCloseToEnemy::Evaluate( Actor &self )
{
	Vector goal;
...
void FlyCloseToEnemy::End( Actor &self )
{
	fly.End( self );
}
...
void FlyCloseToPlayer::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
...
void FlyCloseToPlayer::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyCloseToPlayer::Begin( Actor &self )
{
	if( anim.length())
	{
		self.SetAnim( anim );
...
qboolean FlyCloseToPlayer::Evaluate( Actor &self )
{
	Vector goal;
	Entity *player;
...
void FlyCloseToPlayer::End( Actor &self )
{
	fly.End( self );
}
...
void FlyWander::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
...
void FlyWander::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyWander::Begin( Actor &self )
{
...
qboolean FlyWander::Evaluate( Actor &self )
{
	trace_t trace;
	Vector  dir;
	float   length;
...
void FlyCircle::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
...
void FlyCircle::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyCircle::Begin( Actor &self )
{
	original_z = self.origin.z;
...
qboolean FlyCircle::Evaluate( Actor &self )
{
	Vector   goal;
	trace_t  trace;
	Vector   dir;
...
void FlyDive::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyDive::Begin( Actor &self )
{
	if( anim.length())
		self.SetAnim( anim );
...
qboolean FlyDive::Evaluate( Actor &self )
{
	trace_t  trace;
	Vector   dir;
	Entity   *hit_entity;
...
void FlyClimb::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
...
void FlyClimb::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void FlyClimb::Begin( Actor &self )
{
	if( anim.length())
	{
		self.SetAnim( anim );
...
qboolean FlyClimb::Evaluate( Actor &self )
{
...
void Land::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
}

void Land::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void Land::Begin( Actor &self )
{
	if( anim.length())
	{
		self.SetAnim( anim );
...
qboolean Land::Evaluate( Actor &self )
{
	self.angles[PITCH] = 0;
	self.angles[ROLL] = 0;
...
void GotoDeadEnemy::SetArgs( Event *ev )
{
	anim = ev->GetString( 1 );
}

void GotoDeadEnemy::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
...
void GotoDeadEnemy::Begin( Actor &self )
{
	if( !anim.length())
	{
		anim = "run";
...
qboolean GotoDeadEnemy::Evaluate( Actor &self )
{
	qboolean result;
...
void GotoDeadEnemy::End( Actor &self )
{
	chase.End( self );
}
...
void TurnInvestigate::SetArgs( Event *ev )
{
...
void TurnInvestigate::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
...
void TurnInvestigate::Begin( Actor &self )
{
...
qboolean TurnInvestigate::Evaluate( Actor &self )
{
	str    turn_anim_name;
	Vector dir;
...
void TurnInvestigate::End( Actor &self )
{
	self.SetActorFlag( ACTOR_FLAG_INVESTIGATING, false );
	self.SetActorFlag( ACTOR_FLAG_NOISE_HEARD, false );
	seek.End( self );
...
void TurnToEnemy::SetArgs( Event *ev )
{
	left_anim = ev->GetString( 1 );
	right_anim = ev->GetString( 2 );
	turn_speed = ev->GetFloat( 3 );
...
void TurnToEnemy::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void TurnToEnemy::Begin( Actor &self )
{
	seek.Begin( self );
...
void TurnToEnemy::AnimDone( Event *ev )
{
	anim_done = true;
}

qboolean TurnToEnemy::Evaluate( Actor &self )
{
	str    turn_anim_name;
	Vector dir;
...
void TurnToEnemy::End( Actor &self )
{
	seek.End( self );
}
...
void PickupEntity::SetArgs( Event *ev )
{
	ent_to_pickup = ev->GetEntity( 1 );
	pickup_anim_name = ev->GetString( 2 );
}

void PickupEntity::Begin( Actor &self )
{
	anim_done = false;
...
void PickupEntity::AnimDone( Event *ev )
{
	anim_done = true;
}

qboolean PickupEntity::Evaluate( Actor &self )
{
	if( !ent_to_pickup )
		return false;
...
void PickupEntity::End( Actor &self )
{
	self.SetAnim( "idle" );
...
void ThrowEntity::SetArgs( Event *ev )
{
	throw_anim_name = ev->GetString( 1 );
}

void ThrowEntity::Begin( Actor &self )
{
	anim_done = false;
	self.SetAnim( throw_anim_name, EV_Actor_NotifyBehavior );
}

void ThrowEntity::AnimDone( Event *ev )
{
	anim_done = true;
}

qboolean ThrowEntity::Evaluate( Actor &self )
{
	if( anim_done )
		return false;
...
void ThrowEntity::End( Actor &self )
{
	self.SetAnim( "idle" );
}
...
void BurrowAttack::SetArgs( Event *ev )
{
	use_last_known_position = ev->GetBoolean( 1 );
}

void BurrowAttack::Begin( Actor &self )
{
	Vector  attack_dir;
	Vector  start_pos;
	Vector  end_pos;
...
qboolean BurrowAttack::Evaluate( Actor &self )
{
	Vector  attack_dir;
	Vector  new_origin;
	float   total_dist;
...
void BurrowAttack::SpawnArm( Actor &self, AnimatePtr &leg, Vector arm_origin, const char *anim_name, float angle )
{
	Vector  angles;
	trace_t trace;
	Vector  start_pos;
...
void BurrowAttack::End( Actor &self )
{
}
...
void CircleEnemy::SetArgs( Event *ev )
{
	center_part_name = ev->GetString( 1 );
}

void CircleEnemy::Begin( Actor &self )
{
	ent_to_circle = self.currentEnemy;
	last_angle_change = 0;
}

float CircleEnemy::GetAngleDiff( Actor &self, Actor *center_actor, Vector origin )
{
	Vector dir;
	Vector enemy_angles;
	Vector actor_angles;
...
qboolean CircleEnemy::Evaluate( Actor &self )
{
	Vector dir;
	Actor  *center_actor;
	Vector actor_angles;
...
void CircleEnemy::End( Actor &self )
{
}
...
void ShockWater::Begin( Actor &self )
{
}

qboolean ShockWater::Evaluate( Actor &self )
{
...
void ShockWater::End( Actor &self )
{
	delete left_beam;
	delete right_beam;
	delete center_beam;
...
void Shock::Begin( Actor &self )
{
}

qboolean Shock::Evaluate( Actor &self )
{
	Vector  tag_orig;
	Vector  angles;
	Vector  end_pos;
...
void CircleAttack::SetArgs( Event *ev )
{
	command = ev->GetString( 1 );
	direction = ev->GetString( 2 );
}

Actor *CircleAttack::FindClosestPart( Actor &self, float angle )
{
...
void CircleAttack::Begin( Actor &self )
{
...
qboolean CircleAttack::Evaluate( Actor &self )
{
...
void CircleAttack::End( Actor &self )
{
}
...
void DragEnemy::SetArgs( Event *ev )
{
	tag_name = ev->GetString( 1 );
	damage = ev->GetInteger( 2 );
...
void DragEnemy::Begin( Actor &self )
{
	Actor  *body;
	Vector dir;
	Vector angles;
...
qboolean DragEnemy::Evaluate( Actor &self )
{
	Vector orig;
	str    anim_name;
...
void Spin::SetArgs( Event *ev )
{
	speed = ev->GetFloat( 1 );
}

void Spin::Begin( Actor &self )
{
...
qboolean Spin::Evaluate( Actor &self )
{
	return true;
}

void Spin::End( Actor &self )
{
	SpinningPlant *spinningPlant = (SpinningPlant *)&self;
...
{
	{ &EV_Behavior_AnimDone, &Digest::AnimDone },
	{ NULL, NULL }
};


void Digest::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void Digest::Begin( Actor &self )
{
	float  range = 150;
	Entity *ent_in_range;
...
void Digest::Eat( Entity *food, Actor &self )
{
	float mass;
...
qboolean Digest::Evaluate( Actor &self )
{
	Vector   dir;
	Entity   *food;
	int      i;
...
void Digest::AnimDone( Event *ev )
{
	anim_done = true;
}

void Digest::End( Actor &self )
{
}
...
void Teleport::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void Teleport::Begin( Actor &self )
{

}

qboolean Teleport::TestPosition( Actor &self, int test_pos, Vector &good_position, qboolean use_enemy_dir )
{
...
qboolean Teleport::Evaluate( Actor &self )
{
...
void TeleportToPosition::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void TeleportToPosition::SetArgs( Event *ev )
{
	teleport_position_name = ev->GetString( 1 );
	number_of_teleport_positions = ev->GetInteger( 2 );
}

void TeleportToPosition::Begin( Actor &self )
{
}

qboolean TeleportToPosition::Evaluate( Actor &self )
{
	Vector   dir;
	Vector   angles;
	trace_t  trace;
...
void TeleportToPosition::End( Actor &self )
{
}
...
void GhostAttack::SetArgs( Event *ev )
{
	real_attack = ev->GetBoolean( 1 );
}

void GhostAttack::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void GhostAttack::Begin( Actor &self )
{
...
qboolean GhostAttack::Evaluate( Actor &self )
{
	Vector   dir;
	float    dist;
	float    zdist;
...
void GhostAttack::End( Actor &self )
{
...
void Levitate::SetArgs( Event *ev )
{
	distance = ev->GetFloat( 1 );
	speed = ev->GetFloat( 2 );
}

void Levitate::ShowInfo( Actor &self )
{
	Behavior::ShowInfo( self );
}

void Levitate::Begin( Actor &self )
{
	final_z = self.origin.z + distance;
}

qboolean Levitate::Evaluate( Actor &self )
{
	trace_t trace;
	Vector  start;
	Vector  end;
