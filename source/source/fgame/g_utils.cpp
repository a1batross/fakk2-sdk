...
trace_t G_Trace( vec3_t start, vec3_t mins, vec3_t maxs, vec3_t end, gentity_t *passent, int contentmask, qboolean cylinder, const char *reason )
{
	int     entnum;
	trace_t trace;
...
void G_BroadcastSound( Entity *soundent, Vector origin, float radius )
{
	Sentient *ent;
	Vector   delta;
	Event    *ev;
