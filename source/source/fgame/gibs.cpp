...
Gib::Gib( str name, qboolean blood_trail, str bloodtrailname, str bloodspurtname, str bloodsplatname, float bloodsplatsize, float pitch )
{
	setSize( "0 0 0", "0 0 0" );
...
void Gib::SprayBlood( Vector start )
{
	Vector  norm;
	trace_t trace;
	Vector  trace_end;
