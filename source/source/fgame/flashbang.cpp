...
{
	{ &EV_FlashbangProjectile_StunTime, &FlashbangProjectile::StunTime },
	{ &EV_FlashbangProjectile_StunRadius, &FlashbangProjectile::StunRadius },
	{ NULL, NULL }
};
...
void FlashbangProjectile::StunTime( Event *ev )
{
	stunTime = ev->GetFloat( 1 );
}

void FlashbangProjectile::StunRadius( Event *ev )
{
	stunRadius = ev->GetFloat( 1 );
}

void FlashbangProjectile::Explode( Event *ev )
{
	Entity *owner;
...
void Flashbang::SpecialFireProjectile( Vector pos, Vector forward, Vector right, Vector up, Entity *owner, str projectileModel, float charge_fraction )
{
