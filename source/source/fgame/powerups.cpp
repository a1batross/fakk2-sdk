...
void CircleOfProtection::SetDamage( Event *ev )
{
	m_damage = ev->GetFloat( 1 );
}

void CircleOfProtection::MinRadius( Event *ev )
{
	m_minradius = ev->GetFloat( 1 );
}

void CircleOfProtection::MaxRadius( Event *ev )
{
	m_maxradius = ev->GetFloat( 1 );
}

void CircleOfProtection::DamageDelay( Event *ev )
{
	m_damage_delay = ev->GetFloat( 1 );
}

void CircleOfProtection::Knockback( Event *ev )
{
	m_knockback = ev->GetFloat( 1 );
}

void CircleOfProtection::Use( Event *ev )
{
	Entity *other;
	int    tag_num;
...
void CircleOfProtection::DoDamage( Event *ev )
{
	Entity   *ent;
...
void CircleOfProtection::Deactivate( Event *ev )
{
	if( m_copmodel )
