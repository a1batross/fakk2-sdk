...
inline void ScriptThread::Archive( Archiver &arc )
{
...
inline void ThreadMarker::Archive( Archiver &arc )
{
	Class::Archive( arc );
...
inline void ScriptMaster::Archive( Archiver &arc )
{
	ScriptThread *ptr;
	int          i, num;
...
inline qboolean ScriptMaster::PlayerReady( void )
{
	return player_ready;
}

inline void ScriptMaster::PlayerNotReady( void )
{
	player_ready = false;
}
