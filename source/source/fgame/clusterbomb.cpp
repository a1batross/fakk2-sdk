...
{
	{ &EV_ClusterBomb_Think, &ClusterBomb::Think },
	{ &EV_ClusterBomb_ClusterCount, &ClusterBomb::ClusterCount },
	{ &EV_ClusterBomb_ClusterModel, &ClusterBomb::ClusterModel },
	{ NULL, NULL }
};
...
void ClusterBomb::Think( Event *ev )
{
...
void ClusterBomb::ClusterModel( Event *ev )
{
	m_clustermodel = ev->GetString( 1 );
}

void ClusterBomb::ClusterCount( Event *ev )
{
	m_clustercount = ev->GetInteger( 1 );
}

void ClusterBomb::Explode( Event *ev )
{
	int    i;
	Vector dir;
