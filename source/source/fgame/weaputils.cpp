...
qboolean MeleeAttack( Vector pos, Vector end, float damage, Entity *attacker, meansOfDeath_t means_of_death, float attack_width, float attack_min_height, float attack_max_height, float knockback, qboolean hit_dead, Container<Entity *> *victimlist )
{
	trace_t  trace;
	Entity   *victim;
	Vector   dir;
...
qboolean SwordAttack( Vector pos, Vector end, Sword *sword, Entity *attacker, float damage_multiplier )
{
	trace_t        trace;
	Entity         *victim;
	Vector         dir;
...
Projectile *ProjectileAttack( Vector start, Vector dir, Entity *owner, str projectileModel, float fraction, float real_speed )
{
	Event      *ev;
...
void ExplosionAttack( Vector pos, Entity *owner, str explosionModel, Vector dir, Entity *ignore, float scale )
{
	Explosion *explosion;
	Event     *ev;
...
void RadiusDamage( Entity *inflictor, Entity *attacker, float damage, Entity *ignore, int mod, float radius, float knockback, qboolean constant_damage )
{
	float  points;
	Entity *ent;
	Vector org;
