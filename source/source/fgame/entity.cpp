...
void Entity::ProcessInitCommands( int index, qboolean cache )
{
	tiki_cmd_t cmds;
...
void Entity::Damage( Entity *inflictor, Entity *attacker, float damage, Vector position, Vector direction, Vector normal, int knockback, int dflags, int meansofdeath )
{
	Event *ev;
...
============
*/
qboolean Entity::CanDamage( Entity *target, Entity *skip_ent )
{
	trace_t trace;
	Vector  pos;
	Entity  *skip_entity;
...
void Entity::Sound( str sound_name, int channel, float volume, float min_dist, Vector *sound_origin )
{
	const char *name = NULL;
	vec3_t     org;
	str        random_alias;
...
void Entity::BroadcastSound( float rad )
{
